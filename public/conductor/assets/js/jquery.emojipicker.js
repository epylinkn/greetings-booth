;(function($) {
  ...
  $.extend(EmojiPicker.prototype, {
    ...
    addPickerIcon: function() {
      ...
      if (this.settings.button) {
        ...
        var iconHeight =
          elementHeight > MAX_ICON_HEIGHT ? MAX_ICON_HEIGHT : elementHeight
    ...
    emojiClicked: function(e) {
      ...
      var emojiUnicode = toUnicode(
        findEmoji(emojiShortcode).unicode[defaults.emojiSet]
      )
    ...
    emojiScroll: function(e) {
      ...
      $.each(sections, function(key, value) {
        ...
        if (
          ...
          (section.className == 'people' && offsetFromTop > 0)
        ) {
          $(section)
            .parents('.emojiPicker')
            .find('nav tab.recent')
      ...
      if (searchTerm.length > 0) {
        ...
        $.each($.fn.emojiPicker.emojis, function(i, emoji) {
          ...
          if (shortcode.indexOf(searchTerm) > -1) {
            results.push(
              '<em><div class="emoji emoji-' + shortcode + '"></div></em>'
            )
          }
        })
  ...
  function getPickerHTML() {
    ...
    if (localStorageSupport) {
      nodes.push(
        '<div class="tab active" data-tab="recent"><div class="emoji emoji-tab-recent"></div></div>'
      )
    }
    ...
    if (localStorageSupport) {
      ...
      nodes.push(
        '<section class="recent" data-count="' +
    ...
    for (var i = 0; i < categories_length; i++) {
      ...
      for (var j = 0; j < category_length; j++) {
        ...
        nodes.push(
          '<em><span class="emoji emoji-' + emoji.shortcode + '"></span></em>'
        )
      }
      nodes.push('</div></section>')
    }
